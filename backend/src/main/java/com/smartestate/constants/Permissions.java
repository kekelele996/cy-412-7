...
public final class Permissions {
    ...
    public static final String REPAIR_VIEW = "repair:view";
    public static final String REPAIR_CREATE = "repair:create";
    public static final String REPAIR_ASSIGN = "repair:assign";
